...
namespace IPv6Tree
{
    ...
    class GeoLiteImporter
    {
        ...
        public static System.Collections.Generic.List<UInt128RangeItem> DirectImport()
        {
            ...
            return DirectImport(fileIPv6);
        }



        public static System.Collections.Generic.List<UInt128RangeItem> DirectImport(string fileName)
        {
            System.Collections.Generic.List<UInt128RangeItem> ls = new System.Collections.Generic.List<UInt128RangeItem>();
            string line;
            ...
            using (System.IO.FileStream fs = System.IO.File.OpenRead(fileName))
            {
                using (System.IO.StreamReader sr = new System.IO.StreamReader(fs))
                {
                    ...
                    for (int lineNumber = 1; (line = sr.ReadLine()) != null; ++lineNumber)
                    {
                        ...
                        ls.Add(
                            new UInt128RangeItem(thisBlock.LowerBound, thisBlock.UpperBound, thisBlock.registered_country_geoname_id)
                        );
                    } // Next counter 
